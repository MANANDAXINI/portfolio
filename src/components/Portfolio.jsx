...
function Portfolio() {
    return (
        <div className="max-w-screen-2xl mx-auto px-4 md:px-20 mt-10">
            ...
            <div className="grid gap-8 pt-10 md:grid-cols-2 lg:grid-cols-2">
                {/* Netflix Clone as Main Project */}
                <div className="col-span-2 border-2 border-gray-200 rounded-lg shadow-lg p-6 cursor-pointer hover:shadow-xl transition duration-300 bg-gradient-to-r from-purple-200 to-purple-300">
                    <div className="w-full h-60 md:h-80 flex items-center justify-center overflow-hidden rounded-lg bg-white shadow-inner">
                        <img src={netflix} className="object-contain w-full h-full" alt="Netflix Clone" />
                    </div>
                    <div className="text-2xl font-bold mt-6 mb-2 text-center text-purple-800">
                        Netflix Clone
                    </div>
                ...
                {/* Other Projects in 2x2 Grid */}
                {carditems.slice(1).map(({ id, logo, name, repoLink }) => (
                    <div key={id} className="border-2 border-gray-200 rounded-lg shadow-lg p-6 cursor-pointer hover:shadow-xl hover:border-purple-500 transition duration-300 bg-gradient-to-r from-gray-100 to-gray-200">
                        <div className="w-full h-40 md:h-48 flex items-center justify-center overflow-hidden rounded-lg bg-white shadow-inner">
                            <img src={logo} className="object-contain w-full h-full" alt={name} />
                        </div>
                        <div className="text-xl font-bold mt-6 mb-2 text-center text-gray-800">
                            {name}
                        </div>
                        <p className="text-gray-700 mb-6 text-center">
