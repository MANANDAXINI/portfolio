  ...
  return (
   ...
   <div name="Contact" className="max-w-screen-2xl container mx-auto px-4 md:px-20">
    ...
    <div className="flex flex-col justify-center items-center mt-5">
        <form action="https://getform.io/f/paygdqpa" method="POST" className="bg-slate-200 w-96 px-8 py-6 rounded-xl">
        <h1 className="text-xl font-semibold mb-4">Send Your Message</h1>
      <div >
        <label className="block text-gray-700">Full Name</label>
        <input className="shadow appearance-none border rounded py-2 px-3 text-gray leading-tight focus:out"
      ...
      <div >
        ...
        <input className="shadow appearance-none border rounded py-2 px-3  h-36 text-gray leading-tight focus:out"
