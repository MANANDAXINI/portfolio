    ...
    <div name="Home" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-20">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2 md:mt-24 mt-12 md:order-1 order-2">
          <span className="text-xl text-gray-600 font-semibold">Welcome To My <strong>Portfolio</strong></span>
              ...
              <ul className="flex space-x-5 py-1">
                <li>
                  <a href="https://twitter.com/daxini_manan?t=5mZELgT5f1VKEDT74XvzrA&s=08" target="_blank">
                    <RiTwitterXLine className="text-2xl  hover:text-blue-600 cursor-pointer hover:scale-110 hover:text-3xl duration-200" />
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/manan_daxini25/?hl=en" target="_blank">
                    <FaInstagram className="text-2xl  hover:text-blue-600 cursor-pointer hover:scale-110 hover:text-3xl duration-200" />
                  </a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/manan-daxini-180b69247/" target="_blank">
                    <FaLinkedin className="text-2xl hover:text-blue-600 cursor-pointer hover:scale-110 hover:text-3xl duration-200" />
                  </a>
                </li>
                <li>
                  <a href="https://discord.com/channels/@me" target="_blank">
                    <FaDiscord className="text-2xl  hover:text-blue-600 cursor-pointer hover:scale-110 hover:text-3xl duration-200" />
                  </a>
                </li>
              </ul>
            </div>
